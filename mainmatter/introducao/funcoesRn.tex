...
\begin{definition}\index{função!de várias variáveis}
    Sejam $A$ e $B$ conjuntos e seja $n\geq 1$.
    Seja $C\subseteq A^n$.
...
\begin{definition}\index{soma de funções}\index{diferença de funções}\index{multiplicação por escalar!de funções}\index{produto escalar!de funções}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item a \emph{soma} de $f$ por $g$ como a função $f+g:A\to\mathbb R^n$ dada por
        \[
            (f+g)(a)=f(a)+g(a);
        \]
        \item a \emph{diferença} de $f$ por $g$ como a função $f-g:A\to\mathbb R^n$ dada por
        \[
            (f-g)(a)=f(a)-g(a);
        \]
        \item o \emph{produto por escalar} de $\lambda$ por $f$ como a função $\lambda f:A\to\mathbb R^n$ dada por
        \[
            (\lambda f)(a)=\lambda f(a);
        \]
        \item o \emph{produto escalar} de $f$ por $g$ como a função $f\cdot g:A\to\mathbb R$ dada por
        \[
...
Nesse caso, denotamos o produto escalar de $f$ por $g$ por $fg$, como definido abaixo.
...
\begin{definition}\index{produto de funções}\index{função recíproca}\index{recíproco de função}\index{quociente de funções}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item O \emph{produto pontual} de $f$ por $g$ é a função $fg:A\to\mathbb R$ dada por
        \[
            (fg)(a)=f(a)g(a).
        \]
        ...
        \]
        \item O quociente de $f$ por $g$ é a função
        \[
            \frac{f}{g}:\{a\in A:g(a)\neq 0\}\to\mathbb R
        \]
        dada por
...
Antes de nos concentrarmos no caso $n=2$, registremos a definição geral.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{funcoesRn/planoXpY.png}
...
\begin{example}\label{exemplo:paraboloide}
    ...
    As seções horizontais obtidas fixando $z=c$, com $c>0$, são
    \[
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{funcoesRn/paraboloide.png}
