...
\begin{proposition}\index{continuidade!ponto isolado}
    ...
    \begin{itemize}
        ...
        \item $p \in A$.
    \end{itemize}
        Se $p$ é um ponto isolado de $A$, então $f$ é contínua em $p$.
\end{proposition}
...
\begin{definition}\index{limite}\index{limite!definição}
    ...
    \end{itemize}
    Dizemos que $L$ é limite de $f$ em $p$ se, para todo $\varepsilon > 0$, existe $\delta > 0$ tal que, para todo $x \in A\setminus\{p\}$,
    \[
        \text{se } d(x, p) < \delta, \text{ então } d(f(x), L) < \varepsilon.
    \]
\end{definition}
