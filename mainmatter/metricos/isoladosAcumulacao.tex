...
\subimport{isoladosAcumulacao}{pontoIsoladoZ}
...
\subimport{isoladosAcumulacao}{exemploPontoIsolado}
...
\subimport{isoladosAcumulacao}{pontoAcumulacao}
...
\subimport{isoladosAcumulacao}{abertosPontosAcumulacao}
...
\begin{proposition}\label{prop:pontoAcumulacaoRemocaoFinitos}
...
\begin{exercise}
    Considere $\mathbb Z$ como subespaço de $\mathbb R$, com a métrica usual.
    Mostre que $\mathbb Z$ não possui pontos de acumulação em $\mathbb R$.
\end{exercise}

\begin{exercise}
    Em $\mathbb R$, com a métrica usual, considere
    \[
        A=]0,1[\cup\{2\}.
    \]
...
\begin{exercise}
    Em $\mathbb R$, com a métrica usual, considere
    \[
        A=\{0\}\cup\left\{\frac1n:n\in\mathbb N,\ n\geq 1\right\}.
    \]
...
\begin{exercise}
    ...
    Mostre que $p$ é ponto isolado de $A$ se, e somente se, existe $r>0$ tal que
    \[
...
\begin{exercise}
    ...
    Mostre que, se $p$ é ponto de acumulação de $A$, então, para todo $r>0$, o conjunto
    \[
        B(p,r)\cap A
    \]
    é infinito.
...
\begin{exercise}
    Seja $A$ um subconjunto aberto de $M$ e seja $p\in A$.
    Mostre que, se $p$ é ponto isolado de $A$, então $p$ é ponto isolado de $M$.
