...
\begin{exercise}
    ...
    Mostre que $A$ é aberto se, e somente se, $A$ pode ser escrito como uma união de bolas abertas de $M$.

    Em outras palavras, mostre que $A$ é aberto se, e somente se, existe uma coleção $\mathcal B$ de bolas abertas de $M$ tal que
    \[
...
\begin{exercise}
    Considere o conjunto $\mathbb Z$ munido da métrica herdada da distância usual de $\mathbb R$.
    Determine quais dos seguintes subconjuntos são abertos em $\mathbb Z$.
\end{exercise}
