...
\begin{proof}
    ...
    Como $B(p,r_p)\subseteq A$ para todo $p\in A$, segue que, segue que $\bigcup_{p\in A} B(p, r_p) \subseteq A$.
...
\begin{proof}
    ...
    Como $\bigcup_{p\in B} B_N(p, r_p)$ é uma união de conjuntos abertos de $N$, segue que $A$ é aberto em $N$.
\end{proof}
